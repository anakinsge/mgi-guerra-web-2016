...
<?php if ($params->get('show_title')) : ?>
        <meta itemscope itemprop="mainEntityOfPage"  itemType="https://schema.org/WebPage" itemid="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>"/>
...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<div itemprop="image" itemscope itemtype="https://schema.org/ImageObject" class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"> 
            <meta itemprop="url" content="<?php echo JRoute::_(JURI::base().htmlspecialchars($images->image_intro)); ?>">
	...
	<?php if ($images->image_intro_caption):
        ...
        ?>
	src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo htmlspecialchars($imgAlt); ?>"/> </div>
<?php endif; ?>
