(function(e) {
	e.extend(e.fn, {
		...
		applyClasses : function(n, r) {
			this.filter(":not(.noexpandable):has(>ul):not(:has(>a))").find(">span").unbind("click.treeview").bind("click.treeview", function(t) {
				if (this == t.target)
					r.apply(e(this).next())
			...
			this.find("div." + t.hitarea).unbind("click.treeview").bind("click.treeview", r);
		},
		treeview : function(n) {
